...
public static class BookApplicationErrors
{
    ...
    static public readonly Error BookIsNotAvailable = ApplicationCommonErrors.CustomConflict(ClassName, "BookIsNotAvailable", "The book is not available for this operation");
