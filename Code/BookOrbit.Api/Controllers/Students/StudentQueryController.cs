    ...
    ISender sender) : ApiController
{
    ...
    [HttpGet("profiles/{studentId:guid}")]
    ...
    [ProducesResponseType(typeof(ProblemDetails), StatusCodes.Status404NotFound)]
    [ProducesDefaultResponseType]
    [EndpointSummary("Retrieve a student's public profile by identifier.")]
    ...
    {
        var query = new GetStudentPublicProfileByIdQuery(studentId);
